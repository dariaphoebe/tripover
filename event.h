...
extern ub4 fillxtime(struct timepatbase *tp,ub4 *xp,ub1 *xpacc,ub4 xlen,ub4 ht0,ub4 ht1,struct sidbase *sp,ub1 *daymap,ub4 tdep,ub4 tid);
extern ub4 fillxtime2(struct timepatbase *tp,ub4 *xp,ub1 *xpacc,ub4 xlen,ub4 ht0,ub4 ht1,struct sidbase *sp,ub1 *daymap,ub4 tdep,ub4 tid);
