...
This will initialise and precompute the network. For 7000-stops Queensland with default settings it takes about an hour.
...
Minimum and maximum transfer times are taken into account, yet you cannot specify these yet.
